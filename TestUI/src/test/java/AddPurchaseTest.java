...
public class AddPurchaseTest {
    ...
    public void checkBasicComponents() throws InterruptedException {
        ...
        driver.findElement(By.id("basic_email")).sendKeys("nhathuoca@gmail.com");
        driver.findElement(By.id("basic_password")).sendKeys("nhathuoca@gmail.com");
        ...
        driver.findElement(By.cssSelector("body > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(7) > div:nth-child(1)")).click();
    ...
    @Test
    public void checkAddPurchase_Success() throws InterruptedException {
        driver.get("http://localhost:3000/");
        driver.manage().window().maximize();
        driver.findElement(By.cssSelector("div[class='ant-space css-dev-only-do-not-override-k6wk4u ant-space-horizontal ant-space-align-center'] div[class='ant-space-item']")).click();
        driver.findElement(By.id("basic_email")).sendKeys("nhathuoca@gmail.com");
        ...
        driver.findElement(By.cssSelector("input[placeholder='Tên người gửi']")).sendKeys("Nhà thuốc A");
        driver.findElement(By.cssSelector("input[placeholder='Tên người nhận']")).sendKeys("Đào Quang Vinh");
        driver.findElement(By.cssSelector("input[placeholder='Loại yêu cầu']")).sendKeys("Xem đơn thuốc");
        ...
        sleep(SLEEP_TIME);
        assertEquals(driver.findElement(By.cssSelector("tbody tr:nth-child(1) td:nth-child(2)")).getText(), "Nhà thuốc A");
        assertEquals(driver.findElement(By.cssSelector("tbody tr:nth-child(1) td:nth-child(3)")).getText(), "Đào Quang Vinh");
        assertEquals(driver.findElement(By.cssSelector("tbody tr:nth-child(1) td:nth-child(6)")).getText(), "Xem đơn thuốc");
        ...
        assertEquals(driver.findElement(By.xpath("//div[contains(text(),'ID đơn thuốc')]")).getText(), "ID đơn thuốc");
        ...
        assertNotEquals(driver.findElement(By.cssSelector("div[class='ant-modal-body'] div:nth-child(10) div:nth-child(2)")).getText(), "");

        assertEquals(driver.findElement(By.cssSelector("div[class='ant-modal-body'] div:nth-child(8) div:nth-child(2)")).getText(), "Xem đơn thuốc");
        ...
        driver.findElement(By.cssSelector("body > div:nth-child(5) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)")).click();
        driver.findElement(By.cssSelector("body > div:nth-child(5) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)")).click();

        driver.findElement(By.cssSelector("body > div:nth-child(4) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)")).click();
    ...
    public void checkClearButton() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("input[placeholder='Tên người nhận']")).sendKeys("Nhà thuốc A");
        driver.findElement(By.cssSelector("input[placeholder='Loại yêu cầu']")).sendKeys("Xem đơn thuốc");
        driver.findElement(By.cssSelector("input[placeholder='Trạng thái']")).sendKeys("Đồng ý");
