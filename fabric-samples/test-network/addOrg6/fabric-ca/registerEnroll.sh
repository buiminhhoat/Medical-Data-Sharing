...
function createOrg6 {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:17054 --caname ca-org6 --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client register --caname ca-org6 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org6 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-org6 --id.name org6admin --id.secret org6adminpw --id.type admin --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer0 msp"
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:17054 --caname ca-org6 -M "${PWD}/../organizations/peerOrganizations/org6.example.com/peers/peer0.org6.example.com/msp" --csr.hosts peer0.org6.example.com --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:17054 --caname ca-org6 -M "${PWD}/../organizations/peerOrganizations/org6.example.com/peers/peer0.org6.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org6.example.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:17054 --caname ca-org6 -M "${PWD}/../organizations/peerOrganizations/org6.example.com/users/User1@org6.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://org6admin:org6adminpw@localhost:17054 --caname ca-org6 -M "${PWD}/../organizations/peerOrganizations/org6.example.com/users/Admin@org6.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org6/tls-cert.pem"
  { set +x; } 2>/dev/null
