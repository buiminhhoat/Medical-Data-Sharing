...
public class Config {
    ...
    public static final int ORG_COUNT = 6;
    ...
    public static final String ORG6_MSP = "Org6MSP";
    //    public static final String ORG5_AFFILIATION = "org5.department1";
    ...
    public static final String INSURANCE_COMPANY_ORG = "org6";
    ...
    public static final String CA_ORG6_ADMIN_IDENTITY_ID = "org6CaAdmin";
    ...
    public static final String CA_ORG6_PEM_FILE = "../fabric-samples/test-network/organizations/peerOrganizations/org6.example.com/ca/ca.org6.example.com-cert.pem";
    public static final String CA_ORG6_URL = "https://localhost:17054";
    ...
    public static final String ORG6_ADMIN_USERNAME = "admin";
    public static final String ORG6_ADMIN_PASSWORD = "adminpw";
    ...
    public static final String ORG6_CONNECTION_PROFILE_PATH = "../fabric-samples/test-network/organizations/peerOrganizations/org6.example.com/connection-org6.json";
